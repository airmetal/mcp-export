        ...
        function (Base64, $http, $cookieStore, $rootScope, $timeout, $mdToast) {
            ...
            service.Login = function (username, password, region, callback) {
                ...
                $http({
                    ...
                    // pass in data as string, important!
                }).then(
                    function (resp) {
                        console.log(JSON.stringify(resp));
                        var x2js = new X2JS();
                        var jsonObj = x2js.xml_str2json(resp.data);
                        console.log(JSON.stringify(jsonObj));
                        var orgId = jsonObj.Account.orgId.__text;
                        var response = {success: true, data: jsonObj, orgId: orgId};
                        callback(response);
                    },
                    function (resp) {
